...
import { postEmergencyDetails, getEmergencyDetails } from "./Services/Api";
import * as Yup from "yup";
import "./EmergencyDetails.css";
import { Country, State, City } from "country-state-city";
import ViewEmergencyDetails from "./ViewEmergencyDetails";
...
const EmergencyDetails = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        const response = await postEmergencyDetails(values);
