...
import { postPersonalDetails, getPersonalDetails } from "./Services/Api";
...
const PersonalDetails = () => {
  ...
  const fetchEmployee = async (email) => {
    try {
      const response = await getPersonalDetails(email);
  ...
  const validateField = (name, value) => {
    ...
    if ((name === "val1" && value === "yes")&&(name === "passportnumber" && value === "")) {
    ...
    if (name === "passportnumber") {
      ...
      if ((name === "val1" && value === "yes")&&(!passportRegex.test(value))) {
        return "Invalid Passport Number";
      }
    }
    if ((name === "val1" && value === "yes")&&(name === "status1" && value === "")) {
      return "Select Passport Status";
    }
    if ((name === "val1" && value === "yes")&&(name === "exp1" && value === "")) {
  ...
  return (
    <div>
      <div className="personalapplication">
        <div className="row justify">
          <div className="col-md-10 mt-5">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group row my-1">
                <h5 className="text-center mb-4">Upload Files</h5>
                <label htmlFor="lwd" className="col-sm-2 col-form-label my-1">
                  Aadhar File
                </label>{" "}
                <div className="col-sm-3 my-1">
